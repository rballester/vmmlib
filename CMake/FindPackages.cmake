...
if(PKG_CONFIG_EXECUTABLE)
  find_package(FFTW )
  if((NOT FFTW_FOUND) AND (NOT FFTW_FOUND))
...
if(FFTW_name)
  list(APPEND FIND_PACKAGES_DEFINES VMMLIB_USE_FFTW)
  set(FIND_PACKAGES_FOUND "${FIND_PACKAGES_FOUND} FFTW")
  link_directories(${${FFTW_name}_LIBRARY_DIRS})
  if(NOT "${${FFTW_name}_INCLUDE_DIRS}" MATCHES "-NOTFOUND")
    include_directories(${${FFTW_name}_INCLUDE_DIRS})
  endif()
endif()

set(VMMLIB_BUILD_DEBS autoconf;automake;cmake;doxygen;git;git-review;pkg-config;subversion)

set(VMMLIB_DEPENDS OpenMP;LAPACK;CBLAS;FFTW)
